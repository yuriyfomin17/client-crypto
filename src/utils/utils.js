export const cryptoCurrencies = ["BTC", "XRP", "ETH", "BCH", "EOS", "LTC", "XMR", "DASH"]
export const priceCurrencies = ["dollar USD", "euro EUR", "pound GBP", "hryvna RUR", "canadian dollar CAD", "swis franc CHF", "new zealand dollar NZD", "australian dollar AUD", "japanese yen JPY"]
export const priceSymbols = ["USD", "EUR", "GBP", "RUR", "CAD", "CHF", "NZD", "AUD", "JPY"]
